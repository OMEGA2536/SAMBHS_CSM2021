    ...
    public partial class frmUsuario : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (uvDatos.Validate(true, false).IsValid)
            {
                ...
                {
                    UltraMessageBox.Show("Las contraseñas no coinciden", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                switch (objEstado)
                {
                ...
                {
                    UltraMessageBox.Show("Usuario Guardado", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
                else
                {
