            ...
            if (uvDatos.Validate(true, false).IsValid)
            {
                ...
                if (objOperationResult.Success == 1)
                {
                    ...
                    using (new PleaseWait(this.Location, "Por favor espere..."))
                    {
                        ...
                        //    Process.Start(dataResp.links.pdf);
                        //}
                        //else
                        //{
        ...
        private void BtnImprimir_Click(object sender, EventArgs e)
        {
            ...
            else if (idDoc == (int)DocumentType.RECIBO_SAN_LORENZO)
            {
                #region OLD
                    ...
                    //    string ruta = GetApplicationConfigValue("rutaEgresos").ToString() + "Prueba de recibo.pdf";
                    //    string calendar = "";
                    //    string person = "";
                    //    DateTime fechaNacimiento = DateTime.Now;
                    //    Recibo_San_Lorenzo.CreateRecibo_San_Lorenzo(ruta + nombre + ".pdf", MedicalCenter, datosP);
                    //    Recibo_Interno.CreateRecibo(ruta, "N009-SR000010815", calendar, fechaNacimiento, serie_correlativo, datosP);
                ...
                #endregion
                string ruta = GetApplicationConfigValue("rutaEgresos").ToString();
                string nroRecigo = txtSerieDoc.Text + "-" + txtCorrelativo.Text;
                ...
                case "v_CodigoInterno":
                    ...
                    if (grdData.ActiveRow.Cells["i_RegistroTipo"].Value.ToString() == "Temporal")
                    {
                        ...
                        else
                        {
                            ...
                            frm.ShowDialog();
                            row.Cells["i_IdTipoOperacion"].Value = frm._TipoTributo;
                            if (frm._NombreProducto != null)
                            {
                                ...
                                row.Cells["i_IdTipoOperacion"].Value = frm._TipoTributo;
                                //row.Cells["i_IdTipoOperacion"].Value = frm._TipoTributo;(string)cboTipoOperacion.Value != "5"
                                //    ? cboTipoOperacion.Value.ToString()
                                //    : "1";
