...
//#if DEBUG
//            txtUserName.Text = @"sa";
//            txtPassword.Text = UserConfig.Default.csTipoMotorBD == TipoMotorBD.MSSQLServer ? "sambhs2015" : "sambhs2015";
            //#endif
            ...
            string fecha ="";
            fecha = System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat.ShortDatePattern;
        ...
        {
            var btnconfigEstado = txtUserName.Text.Trim().ToLower() == "";
        ...
        {
            string pathTemp = Application.StartupPath + @"\Update\";
            pathTemp = pathTemp + "UpdateFIles.exe";
