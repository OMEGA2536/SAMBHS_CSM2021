...
namespace SAMBHS.Windows.SigesoftIntegration.UI.Reports {
    ...
    public class Modelo01_Caja : ReportClass {
        
        public Modelo01_Caja() {
        }
        
        public override string ResourceName {
            get {
                return "Modelo01_Caja.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAMBHS.Windows.SigesoftIntegration.UI.Reports.Modelo01_Caja.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedModelo01_Caja : Component, ICachedReport {
        
        public CachedModelo01_Caja() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Modelo01_Caja rpt = new Modelo01_Caja();
            rpt.Site = this.Site;
            return rpt;
        }
