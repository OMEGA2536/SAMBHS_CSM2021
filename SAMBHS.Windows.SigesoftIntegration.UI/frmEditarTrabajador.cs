...
namespace SAMBHS.Windows.SigesoftIntegration.UI
{
    public partial class frmEditarTrabajador : Form
    {
        ...
        string[] nombreCampos =
        {
            ...
            "txtPuesto", "cboParentesco", "cboAltitud", "cboLugarLabor", "txtExploitedMineral", "txtNacionalidad", "txtResidenciaAnte", "txtReligion","cboMarketing"
        ...
        private void GrabarTrabajadorNuevo()
        {
            ...
            oPersonDto.Grupo = cboGrupo.SelectedValue == null ?-1 : int.Parse(cboGrupo.SelectedValue.ToString());
            oPersonDto.Factor = cboFactorSan.SelectedValue == null ? -1 : int.Parse(cboFactorSan.SelectedValue.ToString());
        ...
        private void frmEditarTrabajador_Load(object sender, EventArgs e)
        {
            ...
            cboEmpresaFacturacion.SelectedValue = datosServico == null ? Constants.CLINICA_SAN_MARCOS : datosServico.OrganizationId;
