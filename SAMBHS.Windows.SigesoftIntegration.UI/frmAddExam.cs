...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmAddExam : Form
    {
        ...
        public frmAddExam(List<string> ListaComponentes, string modo, string protocolId, string pacientId, string serviceId, List<Categoria> DataSource)
        {
            if (DataSource != null)
            {
        ...
        private void frmAddAdditionalExam_Load(object sender, EventArgs e)
        {
            ...
            if (_modo == "HOSPI" || _modo == "ASEG")
            {
                ...
                AgendaBl.LlenarComboUsuarios(cboMedico);
                if (_modo == "ASEG")
                {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            new AgendaBl().UpdateIsFact(_serviceId, 0);
