namespace SAMBHS.Common.Resource
{
    ...
    public enum DocumentType
    {
        ...
        Proforma = 439,
        Irpe = 438,
        EGRESO_CAJA_OCUPACIONAL = 500,
        INGRESO_CAJA_OCUPACIONAL = 501,
        EGRESO_CAJA_ASISTENCIAL = 502,
        INGRESO_CAJA_ASISTENCIAL = 503,
        EGRESO_CAJA_FARMACIA = 504,
        INGRESO_CAJA_FARMACIA = 505,
        RECIBO_SAN_LORENZO = 506
    }
    ...
    public enum EstadoSunat : byte
    {
        ...
        /// <summary>
        /// Estado utilizado cuando se ha enviado con anterioridas este documento
        /// Debe revisar si los datos son los mismos con el enviado, sino debe darle de baja.
        /// </summary>
