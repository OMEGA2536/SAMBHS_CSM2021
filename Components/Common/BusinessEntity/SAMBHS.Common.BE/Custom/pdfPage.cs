...
namespace NetPdf
{
    public class pdfPage : PdfPageEventHelper
    {
        ...
        protected Font footer
        {
            get
            {
              // create a basecolor to use for the footer font, if needed.
                BaseColor grey = new BaseColor(0, 98, 145);
                //HOLO 0, 98, 145
                //SAN MARTIN 98, 24, 99
        ...
        public override void OnEndPage(PdfWriter writer, Document doc)
        {
            ...
            var rutaImg = config.AppSettings.Settings["imgFooter2"].Value; // Sigesoft.Common.Utils.GetApplicationConfigValue("imgFooter2");
