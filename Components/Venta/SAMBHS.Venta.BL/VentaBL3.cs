                    ...
                    switch (tipoConstancia)
                    {
                        case TipoConstancia.ENVIO:
                            ...
                            switch (tipoRepresentacion)
                            {
                                ...
                                //case TipoRepresentacion.PDF: return vta.v_EnlaceEnvio + "/ticket";
                                //case TipoRepresentacion.XML: return vta.v_EnlaceEnvio + "/ticket";
                                //case TipoRepresentacion.CDR: return vta.v_EnlaceEnvio + "/ticket";
